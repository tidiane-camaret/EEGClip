...
if __name__ == "__main__":
    ...
    task_name = (
        args.task_name
    )  # ('pathological', 'age', 'gender', "epilep", "keppra", "dilantin", "seizure","pathological_under_50")
    ...
    if task_name in ["pathological", "age", "gender"]:
        ...
        target_name = "age"
    elif task_name == "pathological_under_50":
    ...
    if task_name == "pathological_under_50":
        s0 = "The patient is under 50 year old and has no pathology"
        s1 = "The patient is under 50 year old and has a pathology"
        s2 = "The patient is over 50 year old and has no pathology"
        s3 = "The patient is over 50 year old and has a pathology"
